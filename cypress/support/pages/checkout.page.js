...
Cypress.Commands.add("clickCheckoutBtn", () => {
  cy.clickElement(checkoutBtn);
});
Cypress.Commands.add("clickContinueBtn", () => {
  cy.clickElement(continueBtn);
});
Cypress.Commands.add("clickFinishBtn", () => {
  cy.clickElement(finishBtn);
});

Cypress.Commands.add("fillFirstNameField", (firstName) => {
  cy.fillField(firstNameField, firstName);
});
Cypress.Commands.add("fillLastNameField", (lastName) => {
  cy.fillField(lastNameField, lastName);
});
Cypress.Commands.add("fillPostalCodeField", (postalCode) => {
  cy.fillField(postalCodeField, postalCode);
});
